    ...
    return (
        <>
            ...
            <form className="mt-24" onSubmit={onSubmitEventHandler}>
                ...
                <div className="flex mx-28 flex-col mb-8">
                    <h1 className="text-xl font-normal mb-2">Article Title: <span className="font-semibold">{article.title}</span></h1>
                    <h1 className="text-xl font-normal mt-2">Article was created at: <span className="font-semibold">{formatDate(article.created_at)}</span></h1>
                </div>
                <Editor
