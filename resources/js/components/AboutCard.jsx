...
export default function AboutCard() {
    return (
        <div className="rounded-xl  w-fit flex flex-col items-center lg:flex-row ">
            <div className="flex card-shadow flex-col bg-darkerBlue rounded-xl relative z-10 mx-2 lg:mx-0 lg:left-4 text-white p-7 max-w-[44rem]">
            ...
            <div className="flex w-72 px-6 card-shadow  border-black border-l-2 lg:border-l-0 border-t-2 border-r-2 border-b-2 relative rounded-xl">
