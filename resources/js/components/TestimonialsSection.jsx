...
export default function TestimonialsSection() {
    return (
        <div className="mt-44 text-center">
            <h2 data-aos="fade-down" className="font-bold text-4xl pt-16" id="testimonials">TESTIMONIALS</h2>
            <p data-aos="fade-up" className="font-medium italic mt-4 text-lg">Find Out Why Our Clients Love Working With Us.</p>
